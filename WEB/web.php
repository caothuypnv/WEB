	...
	<div class="container">
		<div class="menu">
			<div class="topnav" id="myTopnav">
			    ...
			    <a href="./code/gioithieu.html">GIỚI THIỆU</a>
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<div id="carousel-id" class="carousel slide" data-ride="carousel" style="padding-left: 4%;" >
					...
					<div class="carousel-inner">
						<div class="item">
							<img src="./Image/chan.jpg"  width="480">
						</div>
						<div class="item">
					...
					<div class="row">
						<div class="col-md-12 ">
							<div class="thumbnail">
								...
								</br><a href="detailNam.php"><img width = 150px height =150px  src="<?php echo $linkImage.$row['Images']; ?>" ></a>
							</div>
							<div class="caption">
								</br><p>
								...
								<p>
									...
									<a href="DetailProduct.php?id=<?php echo $row['id'] ?>">Chi Tiết Sản Phẩm</a>
								</p>
